...
_(If you know about Poetry then) Preferably use Poetry over Pipenv. If at time of reading Poetry isn't able to detect dotenv, then you may need to install python-dotenv and load `.env` file properties in src/config.py using this library._
